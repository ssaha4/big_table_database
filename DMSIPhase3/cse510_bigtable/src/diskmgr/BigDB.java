...
//	}
	...
	public void destroyIndex() throws IteratorException, UnpinPageException, FreePageException, DeleteFileEntryException, ConstructPageException, PinPageException, IOException, GetFileEntryException, AddFileEntryException
	{
...
//		
		...
		b._bf2 = new BTreeFile(b.name + "Index2", AttrType.attrString, 22, 1);
		b._bf3 = new BTreeFile(b.name + "Index3", AttrType.attrString, 22, 1);
		b._bf4 = new BTreeFile(b.name + "Index4", AttrType.attrString, 44, 1);
		b._bf5 = new BTreeFile(b.name + "Index5", AttrType.attrString, 44, 1);
	...
	public void _initDB(String name) throws HFException, HFBufMgrException, HFDiskMgrException, GetFileEntryException,
			ConstructPageException, AddFileEntryException, FileScanException, TupleUtilsException, InvalidRelation,
			InvalidTypeException, IOException {
		b = new BigT(name);
	}

	public int getindextype(int type) {
		return IndexType;
	}

	public void insert(byte[] arr, int type) throws InvalidSlotNumberException, InvalidTupleSizeException, HFException,
			HFBufMgrException, HFDiskMgrException, Exception {
		MID mid = b.insertMap(arr, type);
		// System.out.println("mid is "+mid);
		// System.out.println("record count is "+b.getMapCnt());
	}


//	public void insertindex(int type)
...
//			FieldNumberOutOfBoundException, InvalidInfoSizeException, IOException, FreePageException, DeleteFileEntryException, GetFileEntryException, AddFileEntryException {
//		b.insertIndex(type);
//	}
...
//		b.removeDuplicates();
	...
	public int getMapCount() throws InvalidSlotNumberException, InvalidInfoSizeException, HFDiskMgrException,
			HFBufMgrException, IOException {
		return b.getMapCnt();
	}

	
	public void populatedb() throws KeyTooLongException, KeyNotMatchException, LeafInsertRecException, IndexInsertRecException, ConstructPageException, UnpinPageException, PinPageException, NodeNotMatchException, ConvertException, DeleteRecException, IndexSearchException, IteratorException, LeafDeleteException, InsertException, FileScanException, TupleUtilsException, InvalidRelation, InvalidTypeException, JoinsException, InvalidTupleSizeException, PageNotReadException, PredEvalException, UnknowAttrType, FieldNumberOutOfBoundException, WrongPermat, GetFileEntryException, AddFileEntryException, IOException {
	...
	public Stream openStreamDB(int orderType, String rowFilter, String colFilter, String valFilter, int numbuf)
			throws InvalidSlotNumberException, HFException, HFDiskMgrException, HFBufMgrException, Exception {
	...
	public void getRowCnt(int numbuf) throws UnknowAttrType, LowMemException, JoinsException, Exception {
		
		b.getRowCnt(numbuf);
	}

public void getColumnCnt(int numbuf) throws UnknowAttrType, LowMemException, JoinsException, Exception {
		
		b.getColumnCnt(numbuf);
	}
	...
	public void read_page(PageId pageno, Page apage) throws InvalidPageNumberException, FileIOException, IOException {
		...
		// System.out.println("page to be read is "+pageno);
