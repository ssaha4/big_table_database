...
class SORTDriver extends TestDriver 
  ...
  protected boolean test1()
  {
   ...
   /* Map t = new Map();
    try {
      t.setHdr((short) 4, new short[] {22,22,22,22});
    }
    catch (Exception e) {
      status = FAIL;
      e.printStackTrace();
...
*/
    ...
    try {
      fscan = new MultipleFileScan("test", attrType, attrSize, (short) 4, 4, projlist, expr);
    }
    catch (Exception e) {
      status = FAIL;
      e.printStackTrace();
