...
//	    }
//	}
    	  String row = t1.getRowLabel()+":"+t2.getRowLabel();
    	  String col = t1.getColumnLabel();
    	  int timestamp = t1.getTimeStamp();
    	  String value = t2.getValue();
    	  Jtuple.setRowLabel(row);
    	  Jtuple.setColumnLabel(col);
    	  Jtuple.setTimeStamp(timestamp);
    	  Jtuple.setValue(value);
