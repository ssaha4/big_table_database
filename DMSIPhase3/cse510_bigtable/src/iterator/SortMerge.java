 ...
 * @throws JoinsException 
  ...
  public SortMerge(AttrType    in1[],               
		   ...
		   
    {
      ...
      nOutFlds = n_out_flds;
      try {
	ts_size = setup_op_map(Jtuple, Jtypes,
					    in1, len_in1,s1_sizes,
					    proj_list,n_out_flds );
	//System.out.println(ts_size.toString());
      }catch (Exception e){
...
//      p_i2.get_next().print();
      ...
      //System.out.println("end of sortmerge");
      ...
      while (true)
	{
	  if (process_next_block)
		...
		if ((tuple2 = p_i2.get_next()) == null)
	      ...
	      comp_res = Maputils.CompareMapWithMap(sortFldType, tuple1,tuple2, jc_in2);
		...
		//  System.out.println("comp_res1: "+ comp_res + "\n");
		  comp_res = Maputils.CompareMapWithMap(sortFldType, tuple1,tuple2, jc_in2);
		}
		...
		//  System.out.println("comp_res2: "+ comp_res + "\n");
	      ...
	      if (comp_res != 0)
		{
	      ...
	      TempTuple1.mapCopy(tuple1);
	      TempTuple2.mapCopy(tuple2); 
						      ...
						      TempTuple1, jc_in1) == 0)
		{
			...
			//  System.out.println("comp_res3: "+ Maputils.CompareMapWithMap(sortFldType, tuple1,
				//      TempTuple1, jc_in1) + "\n");
	  ...
	  if (PredEval.Eval(OutputFilter, TempTuple1, TempTuple2, _in1, _in2) == true)
	    {
		  // Join operator will join tow rows on the basis of conditional expressions
