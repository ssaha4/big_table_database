				...
				switch (input) 
					...
					case 1:
						System.out.println("enter parameters for Batch Insert\n\n "
								...
								+ "[4] number of buffers you want to use for your insertion\n\n"+ "[4] number of buffers you want to use for your insertion\n\n");
						Pcounter.initialize();
						msg = in.nextLine();
					...
					case 2: {
						System.out.println("enter parameters for query\n\n"
								...
								+ "[7] Number of buffers you want to use for your query(should be less than or equal to those given for batch insertion)\n\n");
						...
						if (queryBuf >= numbuf) {
							System.out.println(
									"Number of buffers required for query should not exceed the total number of buffers given in BatchInsert\n");
							break;
						}
